...
function Landing({ isAuthenticated }) {
  ...
  return (
    <div>
      ...
      {/* <Link classNameName="btn btn-primary" to="/login">
        go to login page
      </Link> */}
    ...
    <header className="relative z-50 w-full h-24">
        <div
            ...
            <a href="/" className="relative flex items-center inline-block h-5 h-full font-black leading-none">
                ...
                <span className="ml-3 text-xl text-gray-800">AppName<span className="text-pink-500">.</span></span>
            </a>
...
=======
                <Link to="/register"
                    className="relative z-40 inline-block w-auto h-full px-5 py-3 text-sm font-bold leading-none text-white transition-all transition duration-100 duration-300 bg-indigo-700 rounded shadow-md fold-bold lg:bg-white lg:text-indigo-700 sm:w-full lg:shadow-none hover:shadow-xl">Get
                    Started</Link>
>>>>>>> cd8166c742f2409d79c088d115a1edafc7fd1152
            ...
            <div className="flex flex-col w-full mt-0 lg:flex-row sm:mt-10 lg:mt-20">
                ...
                <div className="w-full max-w-md p-4 mx-auto mb-0 sm:mb-16 lg:mb-0 lg:w-1/3">
                    <div className="relative flex flex-col items-center justify-center w-full h-full p-20 mr-5 rounded-lg">
                        <svg className="absolute w-full h-full text-gray-100 fill-current" style={{zIndex:"-1"}} viewBox="0 0 377 340"
                            xmlns="http://www.w3.org/2000/svg">
                            <g>
                                <g>
                                    <path
                ...
                <div className="w-full max-w-md p-4 mx-auto mb-0 sm:mb-16 lg:mb-0 lg:w-1/3">
                    <div className="relative flex flex-col items-center justify-center w-full h-full p-20 mr-5 rounded-lg">
                        <svg className="absolute w-full h-full text-gray-100 fill-current" style={{zIndex:"-1"}} viewBox="0 0 358 372"
                            xmlns="http://www.w3.org/2000/svg">
                            <g>
                                <g>
                                    <path
                ...
                <div className="w-full max-w-md p-4 mx-auto mb-16 lg:mb-0 lg:w-1/3">
                    <div className="relative flex flex-col items-center justify-center w-full h-full p-20 mr-5 rounded-lg">
                        <svg className="absolute w-full h-full text-gray-100 fill-current" style={{zIndex:"-1"}} viewBox="0 0 378 410"
                            xmlns="http://www.w3.org/2000/svg">
                            <g>
                                <g>
                                    <path
    ...
    <footer className="px-4 pt-12 pb-8 text-white bg-white border-t border-gray-200">
        <div className="container flex flex-col justify-between max-w-6xl px-4 mx-auto overflow-hidden lg:flex-row">
            <div className="w-full pl-12 mr-4 text-left lg:w-1/4 sm:text-center sm:pl-0 lg:text-left">
                ...
                <p className="mt-6 mr-4 text-base text-gray-500">We shorted the distance between distributors and retailers.
                </p>
            </div>
            <div className="block w-full pl-10 mt-6 text-sm lg:w-3/4 sm:flex lg:mt-0">
                ...
                {/* <ul className="flex flex-col w-full p-0 font-medium text-left text-gray-700 list-none">
                 ...
                 <ul className="flex flex-col w-full p-0 font-medium text-left text-gray-700 list-none">
                    ...
                    <li><a href="https://github.com/yashone7/" target="_blank"
                            className="inline-block px-3 py-2 text-gray-500 no-underline hover:text-gray-600">Yashwanth Somayajula</a></li>
                    <li><a href="https://github.com/ratandheeraj" target="_blank"
                            className="inline-block px-3 py-2 text-gray-500 no-underline hover:text-gray-600">Ratan Dheeraj Kadirikota</a></li>
                </ul>
               
                <div className="flex flex-col w-full text-gray-700">
                    <div className="inline-block px-3 py-2 mt-5 font-bold text-gray-800 uppercase md:mt-0">Code is open source</div>
                    <div className="flex justify-start pl-4 mt-2">
                        <a className="flex items-center block text-gray-400 no-underline hover:text-gray-600"
                            target="_blank" rel="noopener noreferrer" href="https://github.com/yashone7/rp_ftx_fe">
        ...
        <div className="pt-4 pt-6 mt-10 text-center text-gray-500 border-t border-gray-100">All rights
            reserved.</div>
